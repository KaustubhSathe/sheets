...
type SpreadSheetStackProps struct {
	awscdk.StackProps
}

func NewSpreadSheetStack(scope constructs.Construct, id string, props *SpreadSheetStackProps) awscdk.Stack {
	...
	getHandler := awscdklambdagoalpha.NewGoFunction(stack, jsii.String("myGoHandler"), &awscdklambdagoalpha.GoFunctionProps{
		...
		Entry:   jsii.String("./handlers/lambda"),
